...
#### Clustering - Dataset
With this data set, sex, race, and age are excluded from the clustering analysis as they could be correlated with group membership. The `Psych.meds` variable is also excluded, as it is more than 50% empty. Finally, any records containing null values are omitted from the dataset. 
...
Only two are considered to be important, which are 'Cocaine' and 'Alcohol'.
...
The most important was 'Cocaine' and 'Abuse', and the others are not as important. 
