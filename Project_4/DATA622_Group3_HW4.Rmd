...
* [*SVM Model: Support Vector Machine Essentials*](http://www.sthda.com/english/articles/36-classification-methods-essentials/144-svm-model-support-vector-machine-essentials/). Statistical tools for high-throughput data analysis by kassambara, 11/03/2018 . 
* [*Basic data analysis with palmerpenguins*](https://www.r-bloggers.com/2020/07/basic-data-analysis-with-palmerpenguins/). RBloggers by  jhk0530, July 10, 2020.
### Code Appendix
